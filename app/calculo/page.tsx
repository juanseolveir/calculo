      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 mb-8">
        ...
        <div className="flex gap-5 mt-4 text-xs text-slate-500">
          <span className="flex items-center gap-1.5">
            <StatusDot status="hecho" size="sm" /> {hechos} hechos
          </span>
          <span className="flex items-center gap-1.5">
            <StatusDot status="revision" size="sm" /> {revision} en revisión
          </span>
          <span className="flex items-center gap-1.5">
            <StatusDot status="pendiente" size="sm" /> {pendientes} pendientes
          </span>
        </div>
      </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex gap-4 mt-2 text-xs text-slate-400">
                    <span className="flex items-center gap-1">
                      <StatusDot status="hecho" size="sm" /> {done}
                    </span>
                    <span className="flex items-center gap-1">
                      <StatusDot status="revision" size="sm" /> {rev}
                    </span>
                    <span className="flex items-center gap-1">
